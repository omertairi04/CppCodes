/*
 * Define a class for a tennis player. For each tennis player, the name, surname,
 * and whether he plays in a league (bool) should be kept.
From the tennis player class inherit a class for a ranked tennis player,
 who will represent a player who plays internationally. For ranked tennis
 players, the rank of tennis player should be further preserved.
